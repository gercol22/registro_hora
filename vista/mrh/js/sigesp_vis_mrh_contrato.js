	   	...
	   	tbar:[{
	        ...
	        handler: function() {
	        	...
	        	var comCatContrato = new com.gerco.vista.comCatalogo({
	        		...
	        		arrfiltro:[{etiqueta:'N&#250;mero',id:'codcontrato',valor:'codcon',tipo:'texto'},
	        				   {etiqueta:'Cliente',id:'razsocial',valor:'razsoc',tipo:'texto'},
	        				   {etiqueta:'N&#250;mero Documento',id:'numcontrato',valor:'numcon',tipo:'texto'}],
	        		rutacontrolador:'../../controlador/mrh/sigesp_ctr_mrh_contrato.php',
