...
class reporteListadoActividad extends reporteEzpdf {
	...
	public function detalleListadoActividad($arrCampos, $total) {
		...
		$la_columna=array('razsoc'=>'<b>Cliente</b>','codcon'=>'<b>Contrato</b>','fecact'=>'<b>Fecha</b>','casman'=>'<b># Caso </b>',
				          'desact'=>'<b>Descripción</b>','canhor'=>'<b>Horas</b>');
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('razsoc'=>array('justification'=>'center','width'=>220),
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('etiqueta'=>array('justification'=>'right','width'=>685),
